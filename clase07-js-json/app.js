...
(function (Enlace) {
    var Manejadora = /** @class */ (function () {
        ...
        Manejadora.Modificar = function (objEliminar) {
            Enlace.Manejadora.showSpinner(true);
            document.getElementById("txtPatente").value = objEliminar._patente;
            document.getElementById("cboMarca").value = objEliminar._marca;
            document.getElementById("txtPrecio").value = objEliminar._precio;
